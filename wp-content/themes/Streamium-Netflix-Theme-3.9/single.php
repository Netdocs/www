	...
	<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    	...
    	<div id="s3bubble-aws" class="video-wrapper">
    		<?php
				...
				if ( ! empty( $s3videoid ) ) : ?>
					<div style="position: relative;padding-bottom: 100.00%;"><iframe style="position: absolute;top: 0;left: 0;width: 100%;height: 100%;" src="<?php echo $s3videoid; ?>" frameborder="0" allowfullscreen="allowfullscreen"></iframe></div>
			<?php endif; ?>
		 	<?php the_content(); ?>
		</div>
