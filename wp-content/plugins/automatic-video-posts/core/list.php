...
function WP_ayvpp_video_posts() {
	...
	$videos = $wpdb->get_col("select a.ID from $wpdb->posts as a join $wpdb->postmeta as b on (a.ID = b.post_id) where b.meta_key='_ayvpp_video' and b.meta_value <> '' order by a.post_date desc limit $start,100");
