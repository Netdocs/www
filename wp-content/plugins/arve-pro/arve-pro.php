...
define( 'ARVE_PRO_PUBLIC_URL', ARVE_PRO_URL . 'public/' );
define( 'ARVE_PRO_ADMIN_URL',  ARVE_PRO_URL . 'admin/' );
...
function arve_pro_init() {
	...
	add_action( 'wp_enqueue_scripts', 'arve_pro_action_register_scripts', 0 );
	add_action( 'wp_enqueue_scripts', 'arve_pro_action_register_styles', 0 );
