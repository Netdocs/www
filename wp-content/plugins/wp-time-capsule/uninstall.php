...
remove_action('run_tc_backup_hook_wptc', 'run_tc_backup_wptc');
remove_action('monitor_tcdropbox_backup_hook_wptc', 'monitor_tcdropbox_backup_wptc');
remove_action('execute_instant_drobox_backup_wptc', 'execute_tcdropbox_backup_wptc');
remove_action('execute_periodic_drobox_backup_wptc', 'execute_tcdropbox_backup_wptc');
