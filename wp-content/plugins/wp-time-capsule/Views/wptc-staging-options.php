...
class Staging_Options_Wptc{
  ...
  <script src="<?php echo $uri ?>/JQueryFileTree/jqueryFileTreeView.js" type="text/javascript" language="javascript"></script>
    ...
    <?php
    echo "<h1 > <a style='display:none'  class='button' id='wptc_staging_submit'>Test staging</a> </a</h1><h2 id='staging_area_wptc'>Staging Area</h2><div id='staging_current_progress' style='display:none'>Checking status...</div><div id='dialog_content_id' style='display:none;'> <p> This is my hidden content! It will appear in ThickBox when the link is clicked. </p></div>  <a style='display:none' href='#TB_inline?width=600&height=550&inlineId=dialog_content_id' class='thickbox wptc-thickbox'>View my inline content!</a></div>";
  }
}